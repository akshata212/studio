...
import { Camera, Heart, Users, Calendar, Baby, PartyPopper } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <div key={service.id} id={service.id} className="glass p-8 rounded-[2.5rem] flex flex-col border-none shadow-sm hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-primary font-bold mb-6">{service.price}</p>
              ...
              <Button asChild className="rounded-full w-full py-6 h-auto text-lg">
